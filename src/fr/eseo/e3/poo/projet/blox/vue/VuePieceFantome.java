...
/**
 * Classe qui dessine la pièce fantôme (ghost piece) en transparent
 */
public class VuePieceFantome extends VuePiece {

    /**
     * Crée une vue pour la pièce fantôme
     *
    ...
    public void afficherPiece(Graphics2D g2D) {
        ...
        for (Element e : this.piece.getElements()) {
            ...
            g2D.setColor(new Color(100, 100, 100, 80)); // gris transparent
